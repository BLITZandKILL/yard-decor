<html lang="en" class="full" xmlns="http://www.w3.org/1999/xhtml"><head>
  ...
  <title>404 | Rockhinn Yard Decor</title><!-- Bootstrap core CSS -->
  ...
  <div class="container" style="background-color: rgba(225, 255, 232, 0.65);padding-bottom: 0px;">
    ...
    <div class="row">
      <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12" align="center">
        ...
        <p class="section-header"><b>404 Error - Page Not Found</b></p>
        <div class="row">
          <div class="col-lg-12">
            <div class="alert alert-danger" role="alert">
                    ...
                    <h4>Either the item that you were looking for no longer exists, or this was a fluke and you should try again!</h4>
                    <br>
                    <br>
                    <br>
                    <br>
...
<div class="row">
    <div class="col-lg-12 footer" align="right">
